...
input length6 = 20;
input displace6 = -50; 
plot AvgExp1 = ExpAverage(price[-displace], length);
plot UpSignal1 = price crosses above AvgExp;
plot DownSignal1 = price crosses below AvgExp;
...
plot AvgExp2 = ExpAverage(price[-displace], length);
plot UpSignal2 = price crosses above AvgExp;
plot DownSignal2 = price crosses below AvgExp;
...
plot AvgExp3 = ExpAverage(price[-displace], length);
plot UpSignal3 = price crosses above AvgExp;
plot DownSignal3 = price crosses below AvgExp;
